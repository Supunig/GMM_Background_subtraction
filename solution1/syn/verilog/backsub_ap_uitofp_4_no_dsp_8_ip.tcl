...
create_ip -name floating_point -version 7.0 -vendor xilinx.com -library ip -module_name backsub_ap_uitofp_4_no_dsp_8
# BEGIN Vivado Commands 
...
set_property -dict [list CONFIG.a_precision_type Custom \
                          ...
                          CONFIG.component_name backsub_ap_uitofp_4_no_dsp_8 \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips backsub_ap_uitofp_4_no_dsp_8] -quiet
# END Vivado Parameters
set_property generate_synth_checkpoint false [get_files backsub_ap_uitofp_4_no_dsp_8.xci]
generate_target {synthesis simulation} [get_files backsub_ap_uitofp_4_no_dsp_8.xci]
