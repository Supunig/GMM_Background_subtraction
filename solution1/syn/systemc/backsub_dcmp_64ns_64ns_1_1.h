...
#ifndef __backsub_dcmp_64ns_64ns_1_1__HH__
#define __backsub_dcmp_64ns_64ns_1_1__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(backsub_dcmp_64ns_64ns_1_1) {
    ...
    SC_CTOR(backsub_dcmp_64ns_64ns_1_1):  ACMP_dcmp_comb_U ("ACMP_dcmp_comb_U") {
